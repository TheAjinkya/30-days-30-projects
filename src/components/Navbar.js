...
function Navbar() {
    ...
    return (<div>
        ...
        <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-auto h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 border-r-2">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/reduxcart">Home</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/news">NewsApp</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/quiz">QuizApp</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/context">Counter Context</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/reduxcart">Redux Cart</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/counter">Counter ReduxToolKit</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/unsplash">PhotoApp</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/audioplayer">React Audio Player</NavLink>
                            </span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 text-left whitespace-nowrap">
                                <NavLink to="/git">Github Users</NavLink>
                            </span>
                        </a>
                    </li>
                </ul>
        ...
        {/* <nav className='bg-indigo-500 flex text-white p-4'>
            ...
            <NavLink className="m-2" style={styleLinkObject} to="/counter">CounterApp</NavLink>
